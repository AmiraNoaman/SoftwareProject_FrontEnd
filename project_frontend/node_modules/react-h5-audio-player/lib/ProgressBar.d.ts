...
declare class ProgressBar extends Component<ProgressBarProps, ProgressBarState> {
    ...
    handleContextMenu: (event: React.SyntheticEvent<Element, Event>) => void;
    handleMouseDownOrTouchStartProgressBar: (event: React.MouseEvent<Element, MouseEvent> | React.TouchEvent<Element>) => void;
...
declare const ProgressBarForwardRef: (props: ProgressBarForwardRefProps, ref: React.Ref<HTMLDivElement>) => React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)>;
